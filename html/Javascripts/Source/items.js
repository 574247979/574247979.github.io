...
function getItemLinks(no, nt)
{
	...
	if (perYou.getInventoryItem(no) >= 10 && perYou.getInventoryItem(no) <= 20) {
		// Spell
		if (gameState.bUseIcons) {
			if (itm == 16 && isPossess()) return '<a href="javascript:Dispossession()"><img class="image-hover-highlight" src="' + getThemeFolderI(nt) + 'delete.png" style="object-fit:cover;width:15%;margin-right:5px;max-height:2em' + st +'" title="End the Spell" alt="End the Spell"></a>';
				...
				'<a href="javascript:HandleItem(' + no + ',2,true,true)"><img class="image-hover-highlight" src="' + getThemeFolderI(nt) + 'mana.png" style="object-fit:cover;width:15%;margin-right:5px' + st + '" title="Cast" alt="Cast"></a>';
			}
			return '<a href="javascript:HandleItem(' + no + ',2,true,true)"><img class="image-hover-highlight" src="' + getThemeFolderI(nt) + 'mana.png" style="object-fit:cover;width:15%;margin-right:5px;max-height:2em' + st + '" title="Cast" alt="Cast"></a>' +
				'<a href="javascript:HandleItem(' + no + ',1,true,true)"><img class="image-hover-highlight" src="' + getThemeFolderI(nt) + 'information.png" style="object-fit:cover;width:15%;margin-right:2px;max-height:2em' + st + '" title="Review" alt="Review"></a>';
		}
	...
	if (gameState.bUseIcons) {
		...
		return '<a href="javascript:HandleItem(' + no + ',5)"><img class="image-hover-highlight" src="' + getThemeFolderI(nt) + 'drop.png" width="15%" style="object-fit:cover;margin-right:5px;max-height:2em' + st + '" title="Drop" alt="Drop"></a>' +
				 '<a href="javascript:HandleItem(' + no + ',3)"><img class="image-hover-highlight" src="' + getThemeFolderI(nt) + 'give.png" width="15%" style="object-fit:cover;margin-right:2px;max-height:2em' + st + '" title="Give" alt="Give"></a>' +
				 '<a href="javascript:HandleItem(' + no + ',2)"><img class="image-hover-highlight" src="' + getThemeFolderI(nt) + 'use.png" width="15%" style="object-fit:cover;margin-right:2px;max-height:2em' + st + '" title="' + (itm == 4 ? 'Open' : 'Use') + '" alt="' + (itm == 4 ? 'Open' : 'Use') + '"></a>' +
				 '<a href="javascript:HandleItem(' + no + ',1)"><img class="image-hover-highlight" src="' + getThemeFolderI(nt) + 'examine.png" width="15%" style="object-fit:cover;margin-right:2px;max-height:2em' + st + '" title="Examine" alt="Examine"></a>';
	}
...
function getInventoryContents(nState)
{
	...
	if (nState == 1) {
		...
		s = '<span class="zoom-icon" style="position:absolute;bottom:8px;left:0px"><img draggable="false" style="cursor:pointer;" onclick="showRightBar(2)" src="' + getThemeFolderI(nt) + 'collapse.png" width="24" height="24" alt="Zoom" title="Hide your inventory"></span>' +
		...
		if ((perYourBody.NoItems + perYou.extra[3]) !== 0) {
			...
			for (i = 1 ; i <= perYou.NoItems ; i++) {
				...
				if (gameState.bUseIcons) {
					...
					//if (gameState.nWidth < 800) 
					s += '</span><br><span style="clear:both">';
					s += getItemLinks(i, nt);
					s += '</span></b></div></div>';
