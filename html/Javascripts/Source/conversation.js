...
function addOptionLink(doc, lnk, js, pclass, sty, id)
{
	...
	if (nv && !bMove && doc !== "ss" && doc !== "string") {
		if (sType === "" && Place != 10 && Place != 214 && Place != 444 && Place != 442) {
			if (isInvisible() && lnk.indexOf("visit ") == -1 && lnk.indexOf("wait ") == -1 && lnk.indexOf("meditate ") == -1 && lnk.indexOf("relax ") == -1 && lnk.indexOf("sit on ") == -1 && lnk.indexOf("search ") == -1 && lnk.indexOf("enter ") == -1 && lnk.indexOf("look ") == -1 && lnk.indexOf("go to ") == -1 && lnk.indexOf("go in ") == -1) return '';
		}
	}
