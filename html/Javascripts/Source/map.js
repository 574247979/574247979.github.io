...
var oPlaceMap = {
	"2"  : { ar: [3,6,7,8,28,29] },
	"9"  : { ar: [10,11,27,69,70,72,74,75,76,144,145,234,252] },
	...
	"302": { ar: [303] },
	"317": { ar: [318,319,320,321,322,326,327,332,382,383,384] },
...
function renderMap(clkfn)
{
	...
	map['Radio_Drive'].addBuilding(		370,	"TV &amp; Radio Station",	"Images/radio1.jpg",		{x:85, y:(85/277*237)}, {x:570, y:403}, 1000); //width="277" height="237"
