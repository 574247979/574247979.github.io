...
function initialiseEllie()
{
	...
	per.whereNow = function() {
		...
		if (isPlaceKnown("ConstructionSite") && checkPersonFlag("Kristin", 10) && !this.isCharmedBy("You") && !isWeekDay() && (this.other == 0 || this.hoursSince() < 1)) return 480;
		return this.place;
	};
	...
	per.showEventRoad = function()
	{
		...
		if (sType === "elliecharm1") {
			...
			if (perYou.checkFlag(26)) addLinkToPlaceO(md, 'charm Ellie', Place, 'type=elliecharm2', '', '', "charmPerson('Ellie',2);");
			WritePlaceFooter(md);
			return true;
		}
		...
		if (sType === "elliecharm2") {
			...
			if (clv == 4) {
				...
				md.write(
					...
					'<p>You durectly tell her to remove her dress, Ellie looks surprised tries to resist, and with her remaining willpower she says,</p>' +
		...
		if (sType === "elliecharm3") {
			...
			if (clv == 4) {
				...
				md.write(
					...
					'<p>She starts to tease you, aremoving all clothing except her panties and poses provocatively. She looks back you expectantly.</p>' +
