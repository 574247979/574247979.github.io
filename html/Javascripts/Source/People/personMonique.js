...
function RepliesMonique(nR)
{
	...
	else if (nR == 67)
	{
		...
		addComments('<img src="Images/graveyard.jpg" style="width:20%;float:right;margin-left:5px;margin-bottom:1em" alt="Graveyard">"Just a bit of silliness...", she hesitates and looks behind her startled as if there was someone or something there. She continues,<br><br>"Sorry, I felt a chill...as I was saying, it was just a silly inquiry of public information but he offered a substantial donation to the library for a detailed history of the undead in Glenvale. You know, reports of ghost sightings, supposed vampires and the such. I collated all the reports I could find and delivered them. He said the information was useful, mainly in the timings of the reports."');
