...
function RepliesSirRonald(nR)
{
	...
	else if (nR == 33)
	{
		...
		addComments(
			...
			'<p>He continues, "I can offer you some mundane assistance in your apprenticeship, you are welcome to ask when you need it"'
		);
		perYou.startQuest(1);
		perGates.other = 9;
	}
	...
	else if (nR == 666)
	{
		addComments(
			...
			'<p>He heitates, "There was a <i>woman</i> who once met with me". You can hear the contempt in his voice. "She was a skilled demonologist, and was not yet a demon-slave. She knew much of them and wanted to but certain magics from me. I refused, she had some strange ideas about prices"</p>' +
			'<p>You ask more about this woman, and he answers,</p>' +
			'<p>"She called herself Mistress Jade" he shakes his head, and continues, "apparently she is based out of a \'gentlemans club\' in town. I have no idea where that place is, I doubt it is listed publicly, try asking someone else where it is."</p>' +
