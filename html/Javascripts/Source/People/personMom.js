...
function initialiseMom()
{
	...
	per.showEventPopup = function()
	{
		...
		if ((Place == 45 && !this.checkFlag(9) && isDay() && nFromPlace == 44) || (sType == "zoeydeliverymom")) {
			findPerson("Zoey");
			if (per.dress === "") {
				per.pickModel('As you approach your front door, you see a cute delivery girl knocking on the door.', 'zoeydeliverymom');
			} else {
