...
function initialiseSisterDesiree()
{
				...
				if (!this.checkFlag(8)) {
					...
					addPopupLinkToPlace(md, "quickly check the one on the right", 385, 'type=solodiscipline', "Wrong room",
						...
						(getImagePicked(s, "solodiscipline") == "solodisciplinea" ? 
							'<p>She is kneeling on the floor, naked and bound, and before you can explain or apologise she says "Tell Mother Superior I am doing my penace as she ordered, there is no need to check up on me". You decide to play along, nod you head and leave.<p>'
	...
	per.isPhoneable = function() {
		// Can you call them?
		return (checkPersonFlag("Sofia", 14) && !checkPersonFlag("Sofia", 15) && Place == 14) ||	// Angelica pick up bible
				 (checkPlaceFlag("Hotel", 11) && Place == 269 && this.isCharmedBy());					// Pool
	};
