...
function ShowPlace239()
{
	...
	if (!isPossess() && !checkPlaceFlag("Museum", 8) && perGina.isCharmedBy()) md.write('<p>You see your slave Gina waving to you and gesturing towards a door, the security office it seems.</p>');
