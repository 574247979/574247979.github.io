...
function ShowPlace427()
{
	...
	if (clvC === 0) {
		if (perYou.isMan()) md.write('<p>' + nm + '\'s Salon is a women only salon and the owner does not hesitate to tell you that. She does not force you to leave but it it clear that she does not want you there.</p>');
		else md.write('<p>The owner tells you "I require appointments, and I am only taking new customers by referral now."</p>');
